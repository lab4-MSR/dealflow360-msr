  ...
  return (
    <div className="min-h-screen bg-background flex flex-col relative overflow-hidden selection:bg-primary/20 selection:text-primary">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-rose-500/10 dark:bg-rose-500/15 rounded-full blur-3xl" />
      </div>
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        <div className="w-full max-w-xl text-center space-y-8 animate-page-enter">
          ...
          <div className="relative flex flex-col items-center justify-center">
            <span className="text-[120px] sm:text-[160px] font-extrabold tracking-tighter text-rose-200/40 dark:text-rose-950/40 select-none leading-none font-mono">
              403
            </span>
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="h-20 w-20 rounded-3xl bg-card border border-rose-500/30 shadow-elevation-3 flex items-center justify-center text-rose-500 backdrop-blur-md">
          ...
          <div className="space-y-3">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-rose-500/10 text-rose-600 dark:text-rose-400 border border-rose-500/20 text-xs font-semibold">
          ...
          {user && (
            <div className="rounded-2xl border border-border/80 bg-card/90 backdrop-blur-md p-5 text-left shadow-elevation-2 space-y-3">
              <div className="flex items-center justify-between pb-2 border-b border-border/60">
                ...
                <span className="text-xs text-muted-foreground">Tenant Context</span>
              </div>
