...
const MOCK_HIGH_RISK_DEALS: HighRiskDealItem[] = [
  {
    ...
    primary_risk_driver: 'Dual Threshold Breach (Discount + Margin)',
  ...
  },
  {
    ...
    primary_risk_driver: 'SLA Escalation Window Breached',
    approval_status: 'pending_approval',
  ...
  },
  {
    ...
    primary_risk_driver: 'Silver Tier Maximum Discount Exceeded',
  ...
  },
  {
    ...
    primary_risk_driver: 'Multiple Small Line Discount Accumulation',
...
const MOCK_UPSELL: RecommendationItem[] = [
  {
    ...
    current_product: 'Standard Laptop 14',
    current_product_name: 'Standard Laptop 14',
    recommended_product_id: 'prod-lap-01',
    recommended_product: 'Enterprise UltraBook X1 Pro',
    ...
    potential_revenue_uplift: 240000,
    margin_delta: 58000,
    margin_delta_percent: 4.8,
    margin_percent: 28.5,
  ...
  },
  {
    ...
    current_product: 'Standard SaaS Tier (50 Seats)',
    current_product_name: 'Standard SaaS Tier (50 Seats)',
    recommended_product_id: 'prod-plan-ent',
    recommended_product: 'Enterprise Dedicated Cloud Tier',
    ...
    potential_revenue_uplift: 360000,
    margin_delta: 145000,
    margin_delta_percent: 5.2,
    margin_percent: 42.0,
    minimum_margin_pass: true,
    is_eligible: true,
  },
...
const MOCK_CROSS_SELL: RecommendationItem[] = [
  {
    ...
    recommended_product: 'Premium 24/7 TAM Support & SLA Guarantee',
  ...
  },
  {
    ...
    recommended_product: 'Universal 4K Dual-Display Docking Hub',
    ...
    revenue_delta: 72500,
    potential_revenue_uplift: 72500,
    margin_delta: 24000,
    margin_delta_percent: 4.1,
    margin_percent: 33.1,
    minimum_margin_pass: true,
    is_eligible: true,
...
const MOCK_STALLED_DEALS: StalledDealItem[] = [
  {
    ...
    reason: 'Zero procurement response to revised quotation terms for 20 business days.',
  ...
  },
  {
    ...
    reason: 'Level 2 Finance margin exception waiting on CFO delegation.',
  ...
  },
  {
    ...
    reason: 'Configured partner volume tier conflicts with legacy discount agreement.',
...
export const intelligenceService = {
  async getIntelligenceDashboard(): Promise<IntelligenceDashboardData> {
    ...
    return {
      active_insights_count: 4,
      high_risk_deals_count: 4,
      high_risk_pipeline_value: 7525000,
      identified_revenue_uplift: 672500,
      stalled_deals_count: 3,
      stalled_pipeline_value: 4220000,
  ...
  async getRiskOverview(): Promise<RiskOverviewData> {
    ...
    return {
      total_deals_assessed: 34,
      average_risk_score: 42,
      high_risk_deals: 3,
      critical_risk_deals: 1,
      margin_at_risk: 420000,
      risk_factors: [
        { factor: 'Cloud Services Ceiling Breach', impacted_deals: 4, average_impact: 18.5 },
        { factor: 'Gross Margin Under 25%', impacted_deals: 3, average_impact: 22.0 },
        { factor: 'Multiple Small Line Discount Accumulation', impacted_deals: 5, average_impact: 14.2 },
  ...
  async getDealHealthOverview(): Promise<DealHealthOverviewData> {
    ...
    return {
      ...
      stalled_deals: 3,
      critical_deals: 2,
      critical_pipeline_value: 3270000,
      kpis: {
        healthy: 22,
        at_risk: 7,
        stalled: 3,
