...
export const DealHealthOverviewPage: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Card>
          <CardContent className="pt-5">
            ...
            <p className="text-2xl font-bold text-foreground font-numeric mt-1">18.4 Days</p>
        ...
        <Card>
          <CardContent className="pt-5">
            ...
            <p className="text-2xl font-bold text-primary font-numeric mt-1">82% Opened</p>
        ...
        <Card>
          <CardContent className="pt-5">
            ...
            <p className="text-2xl font-bold text-foreground font-numeric mt-1">4.2 Hours</p>
      ...
      <div className="p-5 rounded-xl border border-warning/30 bg-warning/5 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>
        ...
        <Button size="sm" variant="default" className="text-xs gap-1 shrink-0" asChild>
