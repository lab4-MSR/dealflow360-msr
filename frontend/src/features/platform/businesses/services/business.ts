...
const MOCK_BUSINESSES: { businesses: Business[]; total: number; page: number; perPage: number; totalPages: number } = {
  businesses: [
    { id: 'b1', name: 'Apex Distribution Co.', email: 'admin@apexdist.com', status: 'active', currency: 'USD', timezone: 'America/New_York', plan: 'Enterprise', admin: { id: 'u1', name: 'John Mitchell', email: 'john@apexdist.com', avatar: '' }, usersCount: 48, dealsCount: 342, revenue: 487230, createdAt: '2025-11-15T10:00:00Z' },
    { id: 'b2', name: 'Meridian Logistics', email: 'admin@meridianlog.com', status: 'active', currency: 'USD', timezone: 'America/Chicago', plan: 'Growth', admin: { id: 'u2', name: 'Sarah Chen', email: 'sarah@meridianlog.com', avatar: '' }, usersCount: 32, dealsCount: 218, revenue: 412890, createdAt: '2025-12-03T10:00:00Z' },
    { id: 'b3', name: 'Cascade Enterprises', email: 'admin@cascadeent.com', status: 'active', currency: 'USD', timezone: 'America/Los_Angeles', plan: 'Enterprise', admin: { id: 'u3', name: 'Michael Park', email: 'michael@cascadeent.com', avatar: '' }, usersCount: 56, dealsCount: 287, revenue: 356720, createdAt: '2026-01-20T10:00:00Z' },
    { id: 'b4', name: 'Summit Industries', email: 'admin@summitind.com', status: 'active', currency: 'USD', timezone: 'America/New_York', plan: 'Growth', admin: { id: 'u4', name: 'Emily Torres', email: 'emily@summitind.com', avatar: '' }, usersCount: 28, dealsCount: 156, revenue: 298450, createdAt: '2026-02-10T10:00:00Z' },
    { id: 'b5', name: 'Pinnacle Trading', email: 'admin@pinnacletrading.com', status: 'active', currency: 'EUR', timezone: 'Europe/London', plan: 'Enterprise', admin: { id: 'u5', name: 'David Okafor', email: 'david@pinnacletrading.com', avatar: '' }, usersCount: 42, dealsCount: 198, revenue: 267340, createdAt: '2026-03-05T10:00:00Z' },
    { id: 'b6', name: 'Horizon Supply Chain', email: 'admin@horizonsupply.com', status: 'active', currency: 'USD', timezone: 'America/Denver', plan: 'Starter', admin: { id: 'u6', name: 'Lisa Wang', email: 'lisa@horizonsupply.com', avatar: '' }, usersCount: 15, dealsCount: 89, revenue: 234580, createdAt: '2026-03-22T10:00:00Z' },
    { id: 'b7', name: 'Vanguard Solutions', email: 'admin@vanguardsol.com', status: 'active', currency: 'USD', timezone: 'America/New_York', plan: 'Growth', admin: { id: 'u7', name: 'Robert Kim', email: 'robert@vanguardsol.com', avatar: '' }, usersCount: 22, dealsCount: 134, revenue: 198320, createdAt: '2026-04-08T10:00:00Z' },
    { id: 'b8', name: 'Sterling Commerce', email: 'admin@sterlingcom.com', status: 'active', currency: 'GBP', timezone: 'Europe/London', plan: 'Enterprise', admin: { id: 'u8', name: 'James Wright', email: 'james@sterlingcom.com', avatar: '' }, usersCount: 38, dealsCount: 167, revenue: 176890, createdAt: '2026-04-15T10:00:00Z' },
    { id: 'b9', name: 'Atlas Global Trading', email: 'admin@atlasglobal.com', status: 'pending_setup', currency: 'USD', timezone: 'America/New_York', plan: 'Starter', admin: { id: 'u9', name: 'Anna Petrov', email: 'anna@atlasglobal.com', avatar: '' }, usersCount: 3, dealsCount: 0, revenue: 0, createdAt: '2026-09-01T10:00:00Z' },
    { id: 'b10', name: 'Quick Serve Retail', email: 'admin@quickserve.com', status: 'suspended', currency: 'USD', timezone: 'America/Chicago', plan: 'Starter', usersCount: 8, dealsCount: 45, revenue: 12480, createdAt: '2026-01-10T10:00:00Z' },
    { id: 'b11', name: 'Northwind Traders', email: 'admin@northwind.com', status: 'active', currency: 'CAD', timezone: 'America/Toronto', plan: 'Growth', admin: { id: 'u11', name: 'Mark Thompson', email: 'mark@northwind.com', avatar: '' }, usersCount: 25, dealsCount: 112, revenue: 189340, createdAt: '2026-02-28T10:00:00Z' },
    { id: 'b12', name: 'Pacific Rim Imports', email: 'admin@pacificrim.com', status: 'active', currency: 'USD', timezone: 'America/Los_Angeles', plan: 'Enterprise', admin: { id: 'u12', name: 'Wei Zhang', email: 'wei@pacificrim.com', avatar: '' }, usersCount: 52, dealsCount: 278, revenue: 534210, createdAt: '2025-10-05T10:00:00Z' },
  ],
  total: 247,
  page: 1,
  perPage: 25,
