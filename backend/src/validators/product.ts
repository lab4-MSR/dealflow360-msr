...
export const createPriceListSchema = z.object({ name: z.string().min(1), currency: z.literal('INR').optional(), tier_scope: z.enum(['bronze','silver','gold','platinum']).optional().nullable() }).strict();
